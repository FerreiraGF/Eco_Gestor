...
def exibir_popup():
    messagebox.showinfo("Solicitação Recebida", "Sua solicitação foi recebida. Aguarde nosso feedback.")

janela = Tk()
janela.title("Certificado e Selo Eco Gestor")
janela.geometry("1000x600")
janela.configure(bg="#EAF7EC")

titulo_certificado = Label(
    janela,
    text="Certificado e Selo Eco Gestor",
    font=("Arial", 16, "bold"),
    bg="#EAF7EC",
    fg="#2A5729",
    pady=10
)
titulo_certificado.pack()
...
texto_certificado = Label(
    janela,
    text=certificado_texto,
    font=("Arial", 12),
    justify="left",
    padx=10,
    pady=10,
...
botao_aplicar_certificado = Button(
    janela,
    text="Quero aplicar para o certificado",
    font=("Arial", 12),
    width=30,
    bg="#2A5729",
    fg="white",
    command=exibir_popup
)
botao_aplicar_certificado.pack(pady=10)

botao_acessar_certificado = Button(
    janela,
