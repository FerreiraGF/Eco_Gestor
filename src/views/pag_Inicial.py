...
from views.cadastro import iniciar_cadastro
...
botao_juntar = Button(janela, text="Quero fazer parte", font=("Arial", 18), command=abrir_cadastramento, bg="#2A5729", fg="white", relief="flat")
botao_juntar.pack(pady=20)
